...
class CorrectAnswerModel {
  ...
  async findAll(quizId) {
    return await this.db.executeQuery(`SELECT q.question_id, qmc.choice_id, qmc.is_correct_choice, qgf.sequence_id, qgf.correct_answer, qm.correct_answers, q.type_id
    FROM question q 
